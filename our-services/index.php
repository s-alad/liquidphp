                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-5 col-sm-6">
                                    <div class="hero-slider-content">
                                        <h1 class="slide-title text-white">Best Idea to increase your Business</h1>
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-5 col-sm-6">
                                    <div class="hero-slider-content">
                                        ...
                                        <a href="about.html" class="btn btn-hero btn-all">Read More ></a>
                                    </div>
                                </div>
                                <div class="col-xl-7 col-sm-6">
                                    <div class="slider-thumb moving-vertical">
                ...
                <div class="col-lg-12 wow" data-wow-duration="1s" data-wow-delay=".5s">
                    <div class="about-inner">
                        ...
                        <!--<ul class="our-services-bullets text-white">
									...
									<li><strong>Online Marketing and Digital Platform Content</strong>: press releases, newsfeed posts, and blog posts; articles and newsletters for online publication,</li>
									<li><strong>Social Media Management &amp; Marketing</strong>: creation, development, and management of social media accounts on LinkedIn, Facebook, Instagram, TikTok, and Twitter. Cultivation, engagement, and communication with follower bases, including promotional and media campaigns. Periodic reporting, analysis, and performance analytics.</li>
    ...
    <!--<section class="about-wrapper-area section-padding pt-0 fix">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 offset-lg-1 wow fadeInRight" data-wow-duration="1s" data-wow-delay=".5s">
                        <div class="about-inner">
                            <h2 class="h1 title text-white"><span style="color: red;">Provide</span>  the Best <br> Solutions <span style="color: red;">to Improve</span> <br>your Business</h2>
                                <h3 class="subtitle text-white">Create some exclusive way to solve our customer problems</h3>
                                <p style="color: red;">labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam</p>
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-xl-5 col-sm-6">
                                    <div class="hero-slider-content">
                                        <h1 class="slide-title text-white">Best Idea to increase your Business</h1>
                                        <a href="about.php" class="btn btn-hero btn-all">Read More ></a>
                                    </div>
                                </div>
                                <div class="col-xl-7 col-sm-6">
                                    <div class="slider-thumb moving-vertical">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-xl-5 col-sm-6">
                                    <div class="hero-slider-content">
                                        <h1 class="slide-title">Great Plan to increase your Business</h1>
                                        <a href="about.php" class="btn btn-hero">Read More ></a>
                                    </div>
                                </div>
                                <div class="col-xl-7 col-sm-6">
                                    <div class="slider-thumb moving-vertical">
